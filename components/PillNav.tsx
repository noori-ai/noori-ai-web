...
import Link from 'next/link';            // ⬅️ use Next's Link
...
export interface PillNavProps {
  ...
  logoAlt?: string;
  items: PillNavItem[];
  activeHref?: string;                  // still supported; or use usePathname() externally
  className?: string;
  ease?: string;
  baseColor?: string;
  pillColor?: string;
...
const PillNav: React.FC<PillNavProps> = ({
  ...
  const isInternal = (href?: string) => !!href && !isExternalLink(href);
